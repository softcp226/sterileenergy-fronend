...
const handle_approve_withdrawal = async (btn, withdrawal_request) => {
  ...
  try {
    const response = await fetch(
      "https://sterileenergy-backend01.glitch.me/api/admin/withdrawal/fetch/withdrawal/approve",
...
const handle_delete_withdrawal = async (btn, withdrawal_request) => {
  ...
  try {
    const response = await fetch(
      "https://sterileenergy-backend01.glitch.me/api/admin/withdrawal/fetch/withdrawal/delete",
...
(async () => {
  ...
  try {
    const response = await fetch(
       "https://sterileenergy-backend01.glitch.me/api/admin/withdrawal/fetch",
